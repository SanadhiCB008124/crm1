...
<div class="mt-4">
            ...
            <div class="mt-4">
                <label  class="block text-bg" for="phone" >phone</label>
                <input   type="text"  name="phone"  class="w-full px-4 py-3 rounded-lg bg-gray-200 mt-2 border focus:border-purple-300 focus:bg-white focus:outline-none"/>
            </div>

            <div class="mt-4">
                <label  class="block text-bg" for="name" >address</label>
