...
<div class="flex flex-col mt-4 space-y-2">
                <div class=" items-center px-4 py-6 bg-gray-200 rounded-md shadow-md">
                    ...
                    <div class="mx-4 w-full">
                        ...
                        <div class="text-gray-500">Onsite Registration count for today: {{$siteRegistrationCountPerday ->count()}}</div>
                ...
                <div class=" items-center px-4 py-6 bg-gray-200 rounded-md shadow-md">
                    ...
                    <div class="mx-4 w-full">
                        ...
                        <h4 class="text-gray-500">Website Registration count for today : {{$onlineRegistrations ->count()}}</h4>
            ...
            <div class=" p-4 rounded-lg border border-gray-300 shadow-lg">
                @if(isset($product))
                    <a class="block h-48 overflow-hidden rounded">
                        <img src="{{ asset('images/'.$product->image) }}" alt="{{ $product->name }}" class="h-full  object-cover object-center">
                    </a>
                    <div class="mt-4">
        ...
        <div class=" p-4 rounded-lg ">
            ...
            <div class="p-4 rounded-lg border border-gray-300 shadow-lg">
                @if(isset($leastAddedProduct))
                    <a class="block h-48 overflow-hidden rounded">
                        <img src="{{ asset('images/'.$leastAddedProduct->image) }}" alt="{{ $leastAddedProduct->name }}" class="h-full  object-cover object-center">
                    </a>
                    <div class="mt-4">
        ...
        <div class=" p-4 rounded-lg ">
            ...
            <div class=" p-4 rounded-lg border border-gray-300 shadow-lg">
                ...
                @if(isset($mostViewedProduct))
                    <a class="block h-48 overflow-hidden rounded">
                        <img src="{{ asset('images/'.$mostViewedProduct->image) }}" alt="{{ $mostViewedProduct->name }}" class="h-full  object-cover object-center">
                    </a>
                    <div class="mt-4">
        ...
        <div class=" p-4 rounded-lg ">
            ...
            <div class="p-4 rounded-lg border border-gray-300 shadow-lg">
                ...
                @if(isset($leastViewedProduct))
                    <a class="block h-48 overflow-hidden rounded">
                        <img src="{{ asset('images/'.$leastViewedProduct->image) }}" alt="{{ $leastViewedProduct->name }}" class="h-full  object-cover object-center">
                    </a>
                    <div class="mt-4">
