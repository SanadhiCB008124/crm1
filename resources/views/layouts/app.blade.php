                ...
                <div class="flex flex-wrap items-top mb-6">
                    ...
                    <div class="w-full lg:w-4/12 px-4">
                        ...
                        <ul class="list-unstyled ">
                            ...
                            <li>
                                <a class="text-white hover:text-amber-100 font-semibold block pb-2 text-sm" href="#">Privacy
                                    Policy</a>
                            </li>
                            <li>
                                <a class="text-white hover:text-amber-100 font-semibold block pb-2 text-sm" href="#">Terms
                                    &amp; Conditions</a>
                            </li>
                            <li>
                                <a class="text-white hover:text-amber-100 font-semibold block pb-2 text-sm" href="#">Contact
                                    Us</a>
                            </li>
                        </ul>
                    </div>
